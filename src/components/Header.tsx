                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <Menu as="div" className="relative ml-3">
                            ...
                            >
                                <MenuItem>
                                    <a href="#" className="block px-4 py-2 text-sm text-gray-500 data-[focus]:bg-gray-100">
                                        Profile
                                    </a>
                                </MenuItem>
                                <MenuItem>
                                ...
                                <MenuItem>
                                    <a onClick={handleSignOut} href="#" className="block px-4 py-2 text-sm text-gray-500 data-[focus]:bg-gray-100">
                                        Sign out
                                    </a>
                                </MenuItem>
                            </MenuItems>
