...
export default function ProfileForm() {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg">
            <Button onClick={handleOpenModal} className="rounded bg-gray-600 py-2 px-4 my-4 text-sm text-white data-[hover]:bg-gray-500 data-[hover]:data-[active]:bg-gray-700">
                {t('showModal')}
            </Button>

            <Modal isOpen={isModalOpen} onClose={handleCloseModal} title={t('modalTitle')}>
                <p>{t('modalContent')}</p>
            </Modal>
